...
function AppContent() {
  ...
  /* =====================================================
     ...
     Keeps navigation inside PlacementPro.
     ===================================================== */
  ...
  const handleNavigate = (
    ...
    if (
      ...
      /*
       * Keep every student page inside
       * browser history.
       */
      window.history.pushState(
        { page: tab },
  ...
  /* =====================================================
     PAGES WITHOUT STUDENT APP LAYOUT
     ===================================================== */
